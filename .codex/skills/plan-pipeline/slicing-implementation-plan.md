...
**Expected file:** `.codex/skills/plan-pipeline/SKILL.md`
...
**Expected file:** `.codex/skills/research/SKILL.md`
...
**Expected file:** `.codex/skills/plan-context/SKILL.md`
...
**Expected file:** `.codex/skills/plan-validate/SKILL.md`
...
**Expected file:** `.codex/skills/plan-build/SKILL.md`
...
**Expected file:** `.codex/skills/plan-resolve/SKILL.md`
...
**Expected file:** `.codex/skills/implement/SKILL.md`
...
**Expected file:** `.codex/skills/screen-inventory/SKILL.md`
...
- 8 updated `SKILL.md` files under `.codex/skills/`.
